...
<Container>
	<div class="post">
		<h1>About me</h1>
		<p class="paragraph">
			These are the things I've contributed to projects that aren't quite worth a listing in "projects", but I thought were still worthy of being shared.
		</p>
		...
		<img src="/img/contributions/millmint/search.png" alt="Search on the MillMint website. The query is 'Tzipora' and various results are shown with the represented string">
		...
		<img src="/img/contributions/millmint/tint.png" alt="The tint is applied to the page from the featured image">
		...
		<!-- svelte-ignore a11y-img-redundant-alt -->
		<img src="/img/contributions/millmint/cards.png" alt="A list of stories' cards on the Millmint website, where each card has a slight tint in accordance to the color of the art piece">
	</div>
</Container>